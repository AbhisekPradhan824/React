    ...
    <div className="container-fluid">
      <header className="bg-dark d-flex justify-content-between text-light align-items-center p-3">
        ...
        <div>
          ...
          <span className="me-4">Elrctronics</span>
        </div>
        <div>
          <button className="btn btn-secondary position-relative bi bi-cart3">
      ...
      <section className="row mt-3">
        ...
        <main
          className="col-10 d-flex text-dark flex-wrap overflow-auto"
          style={{ height: "600px" }}
        >
